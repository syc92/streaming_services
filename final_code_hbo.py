...
final_cache_hbo = "final_cache_hbo.json"
page_numbers = list(range(0, 5551, 50))
list_url_base = 'https://reelgood.com/source/hbo?offset='
...
def save_cache_all(cache_item):
    ...
    with open(final_cache_hbo, 'w') as f:
...
def create_table():
    ...
    drop_instructors = '''
        DROP TABLE IF EXISTS hbo;
    '''
    create_instructors = '''
        CREATE TABLE IF NOT EXISTS hbo (
